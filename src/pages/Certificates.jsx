...
const Certificates = () => {
        ...
        <section className='h-[100vh] pt-[2rem] md:pt-[4rem]' id='Achievements'>
            {isModalOpen && (
                <div onClick={handleCloseModal} className=' top-0 h-[100vh] w-full backdrop-blur-md fixed'>
                    <div className=' mt-[15rem] md:mt-[20rem] lg:mt-[8rem] lg:ml-[19rem] w-fit bg-slate-800 mx-auto'>
    ...
    <div className='w-[280px] h-[270px] md:w-[340px] md:h-[400px] rounded-xl bg-slate-100 shadow-lg flex flex-col items-center justify-between'>
        ...
        <div onClick={() => handleCertificateClick(web1)} className='text-center cursor-pointer rounded-lg p-2 md:p-4 w-28 md:w-40 text-[18px] md:text-3xl mb-5 md:mt-8 bg-yellow-400 md:mb-10'>see full</div>
    </div>
    <div className={`w-[280px] h-[270px] ${window.innerWidth >= 768 ? '' : 'mt-5'}  md:w-[340px] md:h-[400px] rounded-xl bg-slate-100 shadow-lg flex flex-col items-center justify-between`}>
        <img className='w-[250px] md:w-[290px] pt-4 md:pt-14' src={web2} alt="Web2" />
        <div onClick={() => handleCertificateClick(web2)} className='text-center cursor-pointer rounded-lg p-2 md:p-4 w-28 md:w-40 text-[18px] md:text-3xl mb-5 md:mt-8 bg-yellow-400 md:mb-10'>see full</div>
    </div>
</div>
